...
progressUpdate(steps: 2500, goal:1000)
progressUpdate(steps: 2500, goal:2600)
progressUpdate(steps: 250, goal:400)
...
pace(currentDistance: 5.0, totalDistance: 6.0, currentTime: 40, goalTime: 60.2)
