...
struct User {
    ...
    func logIn(User: User)  {
        ...
        print("\(currentUser) is currently logged in")
    }
}

var user = User(userName: "agoldbin", email: "agoldbin@madisonCollege.edu", age: 27)
 ...
 */
let newUser = User(userName: "Dixie", email: "ledogge@woof.com", age: 3)
