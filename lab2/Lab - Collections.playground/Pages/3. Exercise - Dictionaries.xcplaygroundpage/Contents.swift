 ...
 */
var daysInMonth: [String: Int] = ["January": 31, "Febtober": 28, "March": 31]
print(daysInMonth)
/*:
 ...
 */
daysInMonth.updateValue(29, forKey: "Febtober")
print(daysInMonth)
/*:
 Use if-let syntax to retrieve the number of days under "January". If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
 */
if let daysInJanuary = daysInMonth.updateValue(31, forKey: "January") {
...
let arrayArray  = ["Shapes": shapesArray, "Colors": colorsArray]
print(arrayArray)
/*:
 ...
 */
if let lastColor = arrayArray["Colors"] {
